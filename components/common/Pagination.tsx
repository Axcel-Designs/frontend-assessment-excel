...
export function Pagination({ currentPage, totalPages, search, category }: PaginationProps) {
  ...
  return (
    <nav className="flex items-center justify-between px-4 py-3 bg-white border-t border-gray-200 sm:px-6 rounded-lg shadow-sm">
